    ...
    case 'POST':
        try {
            ...
            if (!empty($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
                ...
                // Supprimer l'ancienne image si un nouvel article est mis à jour
                if ($id) {
            ...
            if ($id) {
                ...
                $idnews = $pdo->lastInsertId(); // Récupère l'ID de l'article ajouté
                $message = "News ajoutée avec succès.";
            }

            // Répondre avec l'ID de l'article ajouté ou mis à jour
            echo json_encode(['success' => true, 'message' => $message, 'idnews' => $idnews]);
        } catch (Exception $e) {
