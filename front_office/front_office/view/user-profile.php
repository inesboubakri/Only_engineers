            ...
            <div class="flex flex-col items-start text-left relative">
                ...
                <div>
                    ...
                    <div class="flex gap-3">
                        <button class="edit-profile-btn bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition">Edit Profile</button>
                        <button class="settings-btn bg-gray-200 text-gray-800 px-4 py-2 rounded hover:bg-gray-300 transition">Settings</button>
                    </div>
                </div>
            </div>
