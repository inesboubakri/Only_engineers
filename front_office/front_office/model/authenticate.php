...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT user_id, email, password, full_name, is_admin, is_banned FROM users WHERE email = :email");
        ...
        if ($stmt->rowCount() > 0) {
            ...
            if (password_verify($password, $user['password'])) {
                ...
                if ($user['is_banned'] == 1) {
                    ...
                    $_SESSION['signin_error'] = "Your account has been suspended. Please contact support for assistance.";
                    header("Location: ../view/signin.php");
                    exit();
                }
